...
const calendar: Year = [
  ...
  },
  {
    ...
    days: [
      ...
      { date: 3 },
      { date: 4 },
      { date: 5, event: 'Приобретение биржевых облигаций серии БО-001-02 по требованию владельцев' },
      { date: 6, event: 'Выплата купонного дохода по коммерческим облигациям серии КО-СЛ-007' },
      { date: 7 },
      { date: 8 },
      { date: 9 },
      { date: 10 },
      ...
      { date: 17 },
      { date: 18 },
      { date: 19, event: 'Выплата купонного дохода по биржевым облигациям серии БО-001-01' },
      { date: 20 },
      { date: 21 },
      { date: 22 },
      { date: 23 },
